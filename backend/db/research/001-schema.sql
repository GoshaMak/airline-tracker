...
-- explain analyze
-- select * from flights where id = '00000000-0000-0000-0000-000000000000';
...
(
    id                uuid default gen_random_uuid(),
    flight_id         uuid not null, -- TODO: перенести в flights
    departure_gate_id uuid not null,
    arrival_gate_id   uuid not null
);
