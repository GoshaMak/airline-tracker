...
-- +goose Down
drop function if exists add_flight(p_flight_id uuid, p_scheduled_departure timestamp, p_scheduled_arrival timestamp,
                                   p_flight_status varchar, p_flight_plan varchar, p_aircraft_id uuid,
                                   p_departure_airport_id uuid, p_arrival_airport_id uuid, p_departure_gate_id uuid,
                                   p_arrival_gate_id uuid);