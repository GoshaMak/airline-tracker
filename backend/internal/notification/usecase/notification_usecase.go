...
import (
	gateRepository "airline-tracker/internal/airport/domain/repository"
	flightRepository "airline-tracker/internal/flight/domain/repository"
	"airline-tracker/internal/infra/kafka"
	"airline-tracker/internal/notification/domain"
	userRepository "airline-tracker/internal/user/domain/repository"
	"context"
	"errors"
	"fmt"
